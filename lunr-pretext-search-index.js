...
},
{
  ...
  "level": "2",
  "url": "sec-viz-and-dashboard-extensions.html#subsec-dashboard-extension-5",
  "type": "Example",
  "number": "8.8",
  "title": "Filter Bookmarks Example.",
  "body": "Filter Bookmarks Example Use the file below to create a dashboard showing inflation-adjusted salaries over time and showing a boxplot of all inflation-adjusted salaries. (Include any other visualizations you think would be helpful for visualizing this data.) Salaries data file:  Payroll data file:  We're going to use one of the images below with the Filter Bookmarks dashboard extension to create a dashboard like the one below.  Link to Dashboard        "
},
{
...
},
{
  ...
  "level": "1",
  "url": "sec-connecting-to-open-data.html",
  "type": "Section",
  "number": "",
